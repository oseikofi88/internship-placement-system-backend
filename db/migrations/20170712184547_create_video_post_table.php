...
class CreateVideoPostTable extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    public function change()
    {
        ...
        $table = $this->table('video_post',array('id'=> false,'primary_key'=> array('post_id','post_type_id')));
        $table->addColumn('post_id','integer',array('null'=> false))
            ->addColumn('post_type_id','integer',array('null'=> false))
            ->addColumn('video_url','string',array('null'=> false))
